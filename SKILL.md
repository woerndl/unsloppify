...
1. Before producing the final text, scan once against each category above.
2. For any flagged pattern, rewrite — don't soften, remove.
3. One trope used once is fine. Multiple tropes, or the same trope repeated, is the failure mode.
